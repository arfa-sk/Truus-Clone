                        ...
                        <div className="credits-box">
                            <div className="credits-content">
                                <div className="credits-item credit-wiggle">
                                    ...
                                    <div className="overflow-wrapper"><a href="https://github.com/arfa-sk" target="_blank" rel="noopener noreferrer" className="credits-name" data-wiggle-target="true">Arfa Khan</a></div>
                                </div>
                            </div>
                        </div>
